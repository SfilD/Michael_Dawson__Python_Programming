...
# В консервированном объекте хранятся имена игроков и их лучшие результаты
...
def main():
    ...
    welcome(title)
    score = 0
    names_and_scores = shelve.open("ch07_name_scores.dat")
    ...
    if names_and_scores[name] < score:
        names_and_scores[name] = score
    names_and_scores.sync()
    for (i, j) in names_and_scores.items():
        print(i, j)

    names_and_scores.close()
